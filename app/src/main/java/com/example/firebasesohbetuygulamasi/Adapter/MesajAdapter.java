package com.example.firebasesohbetuygulamasi.Adapter;
...
import com.example.firebasesohbetuygulamasi.MessageActivity;
...
public class MesajAdapter extends RecyclerView.Adapter<MesajAdapter.ViewHolder> {
    ...
    public MesajAdapter(Context mContext,List<Chat>mChat,String imageurl)
    {
        this.mChat=mChat;
    ...
    public void onBindViewHolder(@NonNull MesajAdapter.ViewHolder holder, int position) {
        ...
        {
            holder.profile_image.setImageResource(R.drawable.userimage);
        }
        else {
        ...
        if (position==mChat.size()-1){
            ...
            {
                holder.txt_seen.setText("Teslim edildi");
            }
        }
        else
        {
